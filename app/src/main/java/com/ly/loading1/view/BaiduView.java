...
import com.ly.loading1.R;


public class BaiduView extends ViewGroup {
    ...
    public BaiduView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BaiduView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
